...
class SessionDetailViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        // ボタン作成
        let editButton:UIBarButtonItem = UIBarButtonItem(barButtonSystemItem: UIBarButtonSystemItem.edit, target: self, action: #selector(SessionDetailViewController.onEditButton))
    ...
    @objc private func onEditButton() {
        ...
        self.navigationController?.pushViewController(editVC as UIViewController, animated: true)
